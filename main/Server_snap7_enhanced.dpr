...
uses
  ...
  U_dm_import_data_engine in 'import_siemens\U_dm_import_data_engine.pas' {Dm_import_data_engine: TDataModule},
  logthread4 in 'util\logthread4.pas',
  mORMotSCADAUtils in 'util\mORMotSCADAUtils.pas',
  U_get_version in 'util\U_get_version.pas',
  U_tarrayofbyte in 'util\U_tarrayofbyte.pas',
  snap7 in 'snap7\snap7.pas';
